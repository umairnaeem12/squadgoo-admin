...
export const ThemeToggleButton: React.FC = () => {
  const { theme, themeMode, setThemeMode, setManualTheme } = useTheme();
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-12 z-50 w-64 rounded-2xl border border-gray-200 bg-white p-4 text-sm shadow-xl dark:border-gray-800 dark:bg-gray-900">
          ...
          >
            {themeMode === "auto"
              ? "Auto mode is on. Theme follows system settings and time."
              : "Manual mode is on. You control the theme."}
          </div>
